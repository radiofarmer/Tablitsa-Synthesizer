...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Tablitsa Demo Installer\n"
      else:
        line="OutputBaseFilename=Tablitsa Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Tablitsa Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Tablitsa installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Tablitsa Demo installer\n"
     else:
       line="SetupWindowTitle=Tablitsa installer\n"
