...
def main():
  ...
  plistpath = scriptpath + "/resources/Tablitsa-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Tablitsa.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Tablitsa.iss",inplace=1):
